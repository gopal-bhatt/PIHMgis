...
public:
    ...
    void setupUi(QDialog *SoilDataFile)
    {
        ...
        pushButtonSoilDataFile->setGeometry(QRect(475, 41, 98, 32));
        ...
        lineEditSoilDataFile->setGeometry(QRect(145, 42, 325, 29));
        QFont font;
        font.setPointSize(14);
        font.setBold(true);
        font.setWeight(75);
        lineEditSoilDataFile->setFont(font);
        ...
        pushButtonSoilTextureFile->setGeometry(QRect(475, 40, 98, 32));
        ...
        lineEditSoilTextureFile->setGeometry(QRect(145, 41, 325, 29));
        lineEditSoilTextureFile->setFont(font);
