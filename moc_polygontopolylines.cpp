...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PolygonToPolylines_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 125, 26),
QT_MOC_LITERAL(7, 152, 25),
QT_MOC_LITERAL(8, 178, 18)
    },
...
const QMetaObject PolygonToPolylines::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PolygonToPolylines.data,
      qt_meta_data_PolygonToPolylines,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PolygonToPolylines.stringdata))
        return static_cast<void*>(const_cast< PolygonToPolylines*>(this));
