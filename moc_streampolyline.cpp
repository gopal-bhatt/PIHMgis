...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StreamPolyline_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 49, 33),
QT_MOC_LITERAL(4, 83, 35),
QT_MOC_LITERAL(5, 119, 24),
QT_MOC_LITERAL(6, 144, 26),
QT_MOC_LITERAL(7, 171, 25),
QT_MOC_LITERAL(8, 197, 18)
    },
...
const QMetaObject StreamPolyline::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StreamPolyline.data,
      qt_meta_data_StreamPolyline,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StreamPolyline.stringdata))
        return static_cast<void*>(const_cast< StreamPolyline*>(this));
