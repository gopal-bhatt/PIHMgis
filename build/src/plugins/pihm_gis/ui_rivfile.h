...
public:
    ...
    eleFileButton->setGeometry(QRect(466, 64, 81, 32));
    ...
    nodeFileButton->setGeometry(QRect(466, 104, 81, 32));
    ...
    neighFileButton->setGeometry(QRect(466, 143, 81, 32));
    ...
    riverFileButton->setGeometry(QRect(466, 27, 81, 32));
    ...
    groupBox1_3->setGeometry(QRect(14, 243, 571, 71));
    ...
    rivFileButton->setGeometry(QRect(466, 31, 81, 32));
    ...
    messageLog = new QTextBrowser(rivfile);
    ...
    groupBox->setGeometry(QRect(14, 186, 571, 61));
    ...
    groupBox1->setProperty("title", QVariant(QApplication::translate("rivfile", "Input Files", 0, QApplication::UnicodeUTF8)));
    ...
    groupBox1_3->setProperty("title", QVariant(QApplication::translate("rivfile", "Output File", 0, QApplication::UnicodeUTF8)));
