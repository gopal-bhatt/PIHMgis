...
public:
    ...
    QCheckBox *checkBoxSimplifyPolylines;
    ...
    void setupUi(QDialog *SimplifyPolylines)
    {
        ...
        SimplifyPolylines->setPalette(palette);
        ...
        tableWidget->setGeometry(QRect(15, 14, 494, 171));
        ...
        checkBoxSimplifyPolylines->setGeometry(QRect(520, 150, 91, 21));
        QFont font2;
        ...
        checkBoxSimplifyPolylines->setFont(font2);
        checkBoxSimplifyPolylines->setChecked(true);
        ...
        groupBoxButtons->setGeometry(QRect(15, 248, 621, 61));
        ...
        pushButtonClose->setGeometry(QRect(364, 17, 113, 32));
        pushButtonClose->setAutoDefault(false);
        pushButtonRun = new QPushButton(groupBoxButtons);
        pushButtonRun->setObjectName(QStringLiteral("pushButtonRun"));
        pushButtonRun->setGeometry(QRect(500, 17, 113, 32));
        ...
        textBrowserLogs->setGeometry(QRect(15, 326, 621, 71));
        ...
        retranslateUi(SimplifyPolylines);

        QMetaObject::connectSlotsByName(SimplifyPolylines);
    } // setupUi
...
namespace Ui {
    class SimplifyPolylines: public Ui_SimplifyPolylines {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SIMPLIFYPOLYLINES_H
