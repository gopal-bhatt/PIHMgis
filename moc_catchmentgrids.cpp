...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CatchmentGrids_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 47, 33),
QT_MOC_LITERAL(4, 81, 35),
QT_MOC_LITERAL(5, 117, 24),
QT_MOC_LITERAL(6, 142, 26),
QT_MOC_LITERAL(7, 169, 25),
QT_MOC_LITERAL(8, 195, 18)
    },
...
const QMetaObject CatchmentGrids::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CatchmentGrids.data,
      qt_meta_data_CatchmentGrids,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CatchmentGrids.stringdata))
        return static_cast<void*>(const_cast< CatchmentGrids*>(this));
