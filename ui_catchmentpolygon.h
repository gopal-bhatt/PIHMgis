...
public:
    ...
    void setupUi(QDialog *CatchmentPolygon)
    {
        ...
        CatchmentPolygon->resize(611, 419);
        QPalette palette;
        ...
        BorderBottom->setGeometry(QRect(1, 403, 611, 20));
        ...
        groupBoxInput_2->setGeometry(QRect(16, 128, 581, 100));
        textLabel1_2 = new QLabel(groupBoxInput_2);
        textLabel1_2->setObjectName(QStringLiteral("textLabel1_2"));
        textLabel1_2->setGeometry(QRect(16, 39, 131, 31));
        ...
        pushButtonCatchmentPolygon->setGeometry(QRect(475, 39, 98, 32));
        ...
        lineEditCatchmentPolygon->setGeometry(QRect(145, 40, 325, 29));
        QFont font;
        font.setPointSize(14);
        font.setBold(true);
        font.setWeight(75);
        lineEditCatchmentPolygon->setFont(font);
        ...
        checkBoxCatchmentPolygon->setGeometry(QRect(397, 74, 75, 21));
        QFont font1;
        ...
        checkBoxCatchmentPolygon->setFont(font1);
        checkBoxCatchmentPolygon->setChecked(true);
        BorderTop = new QFrame(CatchmentPolygon);
        BorderTop->setObjectName(QStringLiteral("BorderTop"));
        BorderTop->setGeometry(QRect(1, -4, 611, 20));
        ...
        textBrowserLogs->setGeometry(QRect(16, 326, 581, 71));
        ...
        groupBoxButtons->setGeometry(QRect(16, 248, 581, 61));
        ...
        pushButtonCatchmentGrids->setGeometry(QRect(475, 44, 98, 32));
        ...
        textLabel1->setGeometry(QRect(16, 44, 111, 31));
        ...
        lineEditCatchmentGrids->setGeometry(QRect(145, 45, 325, 29));
    ...
    {
        CatchmentPolygon->setWindowTitle(QApplication::translate("CatchmentPolygon", ": :   Catchment Polygon   : :", 0));
        groupBoxInput_2->setTitle(QApplication::translate("CatchmentPolygon", "Output", 0));
        textLabel1_2->setText(QApplication::translate("CatchmentPolygon", "Catchment Polygon", 0));
        pushButtonCatchmentPolygon->setText(QApplication::translate("CatchmentPolygon", "Browse", 0));
        checkBoxCatchmentPolygon->setText(QApplication::translate("CatchmentPolygon", "Load in GIS", 0));
        groupBoxButtons->setTitle(QString());
        pushButtonHelp->setText(QApplication::translate("CatchmentPolygon", "Help", 0));
        pushButtonClose->setText(QApplication::translate("CatchmentPolygon", "Close", 0));
#ifndef QT_NO_TOOLTIP
        pushButtonRun->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        pushButtonRun->setText(QApplication::translate("CatchmentPolygon", "Run", 0));
        groupBoxInput->setTitle(QApplication::translate("CatchmentPolygon", "Input", 0));
        pushButtonCatchmentGrids->setText(QApplication::translate("CatchmentPolygon", "Browse", 0));
        textLabel1->setText(QApplication::translate("CatchmentPolygon", "Catchment Grid", 0));
    } // retranslateUi
