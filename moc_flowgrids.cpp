...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FlowGrids_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 75, 32),
QT_MOC_LITERAL(5, 108, 24),
QT_MOC_LITERAL(6, 133, 26),
QT_MOC_LITERAL(7, 160, 25),
QT_MOC_LITERAL(8, 186, 18)
    },
...
const QMetaObject FlowGrids::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FlowGrids.data,
      qt_meta_data_FlowGrids,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FlowGrids.stringdata))
        return static_cast<void*>(const_cast< FlowGrids*>(this));
