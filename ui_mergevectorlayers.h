...
public:
    ...
    void setupUi(QDialog *MergeVectorLayers)
    {
        ...
        groupBoxButtons->setGeometry(QRect(15, 321, 581, 61));
        ...
        checkBoxMergeLayer->setGeometry(QRect(480, 150, 91, 21));
        QFont font1;
        ...
        checkBoxMergeLayer->setFont(font1);
        checkBoxMergeLayer->setChecked(true);
        ...
        pushButtonMergeLayer->setGeometry(QRect(474, 16, 98, 32));
        ...
        lineEditMergeLayer->setGeometry(QRect(144, 17, 325, 29));
        lineEditMergeLayer->setFont(font);
        textLabel1_2 = new QLabel(groupBoxButtons_2);
        textLabel1_2->setObjectName(QStringLiteral("textLabel1_2"));
        textLabel1_2->setGeometry(QRect(15, 16, 131, 31));
