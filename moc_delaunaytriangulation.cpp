...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DelaunayTriangulation_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 132, 28),
QT_MOC_LITERAL(8, 161, 4),
QT_MOC_LITERAL(9, 166, 27),
QT_MOC_LITERAL(10, 194, 29),
QT_MOC_LITERAL(11, 224, 24),
QT_MOC_LITERAL(12, 249, 26),
QT_MOC_LITERAL(13, 276, 25),
QT_MOC_LITERAL(14, 302, 18)
    },
...
const QMetaObject DelaunayTriangulation::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DelaunayTriangulation.data,
      qt_meta_data_DelaunayTriangulation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DelaunayTriangulation.stringdata))
        return static_cast<void*>(const_cast< DelaunayTriangulation*>(this));
