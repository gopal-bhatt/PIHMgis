...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StreamGrids_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 111, 24),
QT_MOC_LITERAL(6, 136, 26),
QT_MOC_LITERAL(7, 163, 25),
QT_MOC_LITERAL(8, 189, 32),
QT_MOC_LITERAL(9, 222, 18)
    },
...
const QMetaObject StreamGrids::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StreamGrids.data,
      qt_meta_data_StreamGrids,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StreamGrids.stringdata))
        return static_cast<void*>(const_cast< StreamGrids*>(this));
