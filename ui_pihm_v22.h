/********************************************************************************
** Form generated from reading UI file 'pihm_v22.ui'
**
...
#ifndef UI_PIHM_V22_H
#define UI_PIHM_V22_H
...
public:
    ...
    void setupUi(QDialog *PIHM_v22)
    {
        if (PIHM_v22->objectName().isEmpty())
            PIHM_v22->setObjectName(QStringLiteral("PIHM_v22"));
        PIHM_v22->resize(611, 325);
        QPalette palette;
        ...
        PIHM_v22->setPalette(palette);
        groupBoxOutput = new QGroupBox(PIHM_v22);
        ...
        BorderBottom = new QFrame(PIHM_v22);
        ...
        textBrowserLogs = new QTextBrowser(PIHM_v22);
        ...
        groupBoxButtons = new QGroupBox(PIHM_v22);
        ...
        groupBoxOutput->raise();
        BorderTop->raise();
        BorderBottom->raise();
        textBrowserLogs->raise();
        groupBoxButtons->raise();
        progressBar->raise();

        retranslateUi(PIHM_v22);

        QMetaObject::connectSlotsByName(PIHM_v22);
    } // setupUi

    void retranslateUi(QDialog *PIHM_v22)
    {
        PIHM_v22->setWindowTitle(QApplication::translate("PIHM_v22", ": :   PIHM v2.2   : :", 0));
        groupBoxOutput->setTitle(QString());
        textLabel2->setText(QApplication::translate("PIHM_v22", "Input Data Folder", 0));
        pushButtonInputDataFolder->setText(QApplication::translate("PIHM_v22", "Browse", 0));
        textLabel2_2->setText(QApplication::translate("PIHM_v22", "Data Key (ID)", 0));
        textLabel3_24->setText(QApplication::translate("PIHM_v22", "Archive Simulation", 0));
        checkBoxArchive->setText(QString());
        groupBoxButtons->setTitle(QString());
        pushButtonHelp->setText(QApplication::translate("PIHM_v22", "Help", 0));
        pushButtonClose->setText(QApplication::translate("PIHM_v22", "Close", 0));
#ifndef QT_NO_TOOLTIP
        pushButtonRun->setToolTip(QApplication::translate("PIHM_v22", "Note: the dialog will close by itself after execution", 0));
#endif // QT_NO_TOOLTIP
        pushButtonRun->setText(QApplication::translate("PIHM_v22", "Run", 0));
    } // retranslateUi

};

namespace Ui {
    class PIHM_v22: public Ui_PIHM_v22 {};
} // namespace Ui
