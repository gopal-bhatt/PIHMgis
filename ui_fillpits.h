...
public:
    ...
    void setupUi(QDialog *FillPits)
    {
        if (FillPits->objectName().isEmpty())
            FillPits->setObjectName(QStringLiteral("FillPits"));
        FillPits->resize(611, 409);
        QPalette palette;
        ...
        FillPits->setPalette(palette);
        groupBoxInput = new QGroupBox(FillPits);
        groupBoxInput->setObjectName(QStringLiteral("groupBoxInput"));
        groupBoxInput->setGeometry(QRect(17, 17, 581, 100));
        lineEditDEM = new QLineEdit(groupBoxInput);
        lineEditDEM->setObjectName(QStringLiteral("lineEditDEM"));
        lineEditDEM->setGeometry(QRect(132, 44, 325, 29));
        QFont font;
        font.setPointSize(14);
        font.setBold(true);
        font.setWeight(75);
        lineEditDEM->setFont(font);
        pushButtonDEM = new QPushButton(groupBoxInput);
        pushButtonDEM->setObjectName(QStringLiteral("pushButtonDEM"));
        pushButtonDEM->setGeometry(QRect(470, 43, 98, 32));
        pushButtonDEM->setCheckable(false);
        pushButtonDEM->setAutoDefault(false);
        pushButtonDEM->setFlat(false);
        textLabel1 = new QLabel(groupBoxInput);
        textLabel1->setObjectName(QStringLiteral("textLabel1"));
        textLabel1->setGeometry(QRect(20, 43, 70, 31));
        QFont font1;
        ...
        textBrowserLogs->setGeometry(QRect(14, 315, 581, 71));
        textBrowserLogs->setLineWrapMode(QTextEdit::NoWrap);
        groupBoxOutput = new QGroupBox(FillPits);
        groupBoxOutput->setObjectName(QStringLiteral("groupBoxOutput"));
        groupBoxOutput->setGeometry(QRect(16, 121, 581, 100));
        showPF_DFrame = new QCheckBox(groupBoxOutput);
        showPF_DFrame->setObjectName(QStringLiteral("showPF_DFrame"));
        showPF_DFrame->setGeometry(QRect(384, 74, 75, 21));
        QFont font2;
        ...
        showPF_DFrame->setFont(font2);
        showPF_DFrame->setChecked(true);
        lineEditFillPits = new QLineEdit(groupBoxOutput);
        lineEditFillPits->setObjectName(QStringLiteral("lineEditFillPits"));
        lineEditFillPits->setGeometry(QRect(132, 40, 325, 29));
        lineEditFillPits->setFont(font);
        pushButtonFillPits = new QPushButton(groupBoxOutput);
        pushButtonFillPits->setObjectName(QStringLiteral("pushButtonFillPits"));
        pushButtonFillPits->setGeometry(QRect(470, 39, 98, 32));
        ...
        BorderBottom = new QFrame(FillPits);
        BorderBottom->setObjectName(QStringLiteral("BorderBottom"));
        BorderBottom->setGeometry(QRect(1, 393, 611, 20));
        ...
        groupBoxButtons->setGeometry(QRect(14, 237, 581, 61));
