...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PolylineToLines_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_PolylineToLines_t qt_meta_stringdata_PolylineToLines = {
    {
QT_MOC_LITERAL(0, 0, 15),
QT_MOC_LITERAL(1, 16, 24),
QT_MOC_LITERAL(2, 41, 0),
QT_MOC_LITERAL(3, 42, 27),
QT_MOC_LITERAL(4, 70, 26),
QT_MOC_LITERAL(5, 97, 24),
QT_MOC_LITERAL(6, 122, 26),
QT_MOC_LITERAL(7, 149, 25),
QT_MOC_LITERAL(8, 175, 18)
    },
...
const QMetaObject PolylineToLines::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PolylineToLines.data,
      qt_meta_data_PolylineToLines,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PolylineToLines.stringdata))
        return static_cast<void*>(const_cast< PolylineToLines*>(this));
